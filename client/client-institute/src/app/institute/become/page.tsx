...
function becomeInstitute() {
  ...
  const handleInstituteCreateSubmission = (event: FormEvent<HTMLFormElement>) => {
      ...
      <div className="flex items-center justify-center h-screen">
        <div className="w-full max-w-md bg-white p-6 rounded-lg shadow-lg">
          ...
          <form onSubmit={handleInstituteCreateSubmission} className="space-y-4">
            ...
            {/* Mobile Number */}
            <div>
              <input type="number" placeholder="Phone Number" className="w-full px-4 py-2 border border-gray-300 rounded-lg text-gray-700 focus:outline-none focus:ring focus:ring-blue-100" name="institutePhoneNumber" onChange={handleChange} />
            </div>
            {/* Email */}
            <div>
            ...
            {/* Confirm Password */}
            <div className="relative">
              <input type="number" onChange={handleChange} placeholder="Pan No" className="w-full px-4 py-2 border border-gray-300 rounded-lg text-gray-700 focus:outline-none focus:ring focus:ring-blue-100" name="institutePanNo" />
            </div>
            <div className="relative">
              <input type="number" onChange={handleChange} placeholder="Vat No" className="w-full px-4 py-2 border border-gray-300 rounded-lg text-gray-700 focus:outline-none focus:ring focus:ring-blue-100" name="instituteVatNo" />
            </div>
            {/* Submit Button */}
